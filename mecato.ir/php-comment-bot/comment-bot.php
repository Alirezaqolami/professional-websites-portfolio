...
if (!function_exists('mecato_get_qa_pairs')) {
    function mecato_get_qa_pairs() {
        return array(
            ...
            array('question'=>'نصب محصول نیاز به ابزار خاص دارد؟','answer'=>'ابزارهای استاندارد für نصب کافی هستند.'),
            array('question'=>'امکان ارسال فوری وجود دارد؟','answer'=>'بله، ارسال سریع برای اکثر شهرها انجام می‌شود.'),
            array('question'=>'محصول از کجا تامین می‌شود؟','answer'=>'تأمین محصول توسط فروشنده و منابع معتبر انجام می‌شود.'),
